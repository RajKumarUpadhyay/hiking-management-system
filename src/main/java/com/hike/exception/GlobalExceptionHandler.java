...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleFieldValidation(ConstraintViolationException constraintViolationException, WebRequest request) {

        ErrorResponse errorResponse = new ErrorResponse(HttpStatus.UNPROCESSABLE_ENTITY.value(), "Validation error. Check 'errors' field for details.");
        constraintViolationException.getConstraintViolations().stream().forEach(x -> {
            errorResponse.addValidationError(x.getPropertyPath().toString(), x.getMessage());
        });
    ...
    public ResponseEntity<Object> handleRuntimeException(RuntimeException runtimeException, WebRequest request) {
        ...
        return buildErrorResponse(runtimeException, HttpStatus.BAD_REQUEST, request);
    }
